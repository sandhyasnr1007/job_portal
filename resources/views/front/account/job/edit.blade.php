...
@include('front.account.sidebar')
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('account.saveJob') }}" method="put" id="editJobForm" name="editJobForm">
                @csrf
                    ...
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <input value="{{ $job->location }}" type="text" placeholder="Job Location" id="location" name="location" class="form-control">
                                <p></p>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea value="{{ $job->description }}" class="form-control" name="description" id="description" cols="5" rows="5" placeholder="Description">{{ $job->description }}</textarea>
                            <p></p>

                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Benefits</label>
                            <textarea value="{{ $job->benefits }}" class="form-control" name="benefits" id="benefits" cols="5" rows="5" placeholder="Benefits">{{ $job->benefits }}</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Responsibility</label>
                            <textarea value="{{ $job->responsibility }}" class="form-control" name="responsibility" id="responsibility" cols="5" rows="5" placeholder="Responsibility">{{ $job->responsibility}}</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Qualifications</label>
                            <textarea value="{{ $job->qualifications }}" class="form-control" name="qualifications" id="qualifications" cols="5" rows="5" placeholder="Qualifications">{{ $job->qualifications }}</textarea>
                        </div>
                    ...
                    <div class="card-footer  p-4">
                        <button type="submit" class="btn btn-custom">Update Job</button>
                    </div> 
