    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                ...
                <div class="banner-btn mt-5"><a href="#" class="btn btn-custom">Start exploring today !</a></div>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                ...
                <div class=" col-md-3 mb-xs-3 mb-sm-3 mb-lg-0">
                    <div class="d-grid gap-2">
                        <a href="jobs.html" class="btn btn-custom btn-block">Search</a>
                    </div>
                            ...
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="job-detail.html" class="btn btn-custom btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
