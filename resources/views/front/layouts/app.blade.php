...
<head>
	...
	<title>Workforce Solutions | Find Best Jobs</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="index.html">Workforce Solutions</a>
        ...
        <form id="profilePicForm" name="profilePicForm" action="" method="post">
           ...
           <p class="text-danger" id="image-error"></p>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="my-custom-btn mx-3">Update</button>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2025 Workforce Solutions, all right reserved</p>
</div>
</footer> 
